...
/**
 * <p>Classe Java pour enumeratedDataType complex type.
 * 
...
@XmlSeeAlso({
    org.ieee.standards.ieee1516_2010.EnumeratedDataTypesType.EnumeratedData.class
})
public class EnumeratedDataType implements IDataType {
    ...
    public static class Enumerator {
        ...
        @XmlElement(required = true)
        protected IdentifierType name;
        protected List<org.ieee.standards.ieee1516_2010.String> value;
        @XmlAnyElement(lax = true)
        protected Object any;
        @XmlAttribute(name = "notes")
        @XmlIDREF
         ...
         * 
         */
        public List<org.ieee.standards.ieee1516_2010.String> getValue() {
            if (value == null) {
                value = new ArrayList<org.ieee.standards.ieee1516_2010.String>();
            }
            return this.value;
        }
