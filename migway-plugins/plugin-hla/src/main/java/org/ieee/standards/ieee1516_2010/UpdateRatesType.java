...
/**
 * <p>Classe Java pour updateRatesType complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="updateRatesType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="updateRate" type="{http://standards.ieee.org/IEEE1516-2010}updateRateType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "updateRatesType", propOrder = {
    "updateRate",
    "any"
})
public class UpdateRatesType {

    protected List<UpdateRateType> updateRate;
     ...
     * This is why there is not a <CODE>set</CODE> method for the updateRate property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUpdateRate().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<UpdateRateType> getUpdateRate() {
        if (updateRate == null) {
            updateRate = new ArrayList<UpdateRateType>();
        }
