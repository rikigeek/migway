...
/**
 * <p>Classe Java pour fixedRecordDataTypesType complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="fixedRecordDataTypesType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="fixedRecordData" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;extension base="{http://standards.ieee.org/IEEE1516-2010}fixedRecordDataType">
...
@XmlType(name = "fixedRecordDataTypesType", propOrder = {
    "fixedRecordData",
    "any"
})
public class FixedRecordDataTypesType {

    protected List<FixedRecordDataTypesType.FixedRecordData> fixedRecordData;
    ...
    /**
     * Gets the value of the fixedRecordData property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fixedRecordData property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFixedRecordData().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FixedRecordDataTypesType.FixedRecordData }
     * 
     * 
     */
    public List<FixedRecordDataTypesType.FixedRecordData> getFixedRecordData() {
        if (fixedRecordData == null) {
            fixedRecordData = new ArrayList<FixedRecordDataTypesType.FixedRecordData>();
        }
        return this.fixedRecordData;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class FixedRecordData
