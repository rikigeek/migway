...
/**
 * <p>Classe Java pour arrayDataTypesType complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="arrayDataTypesType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="arrayData" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
...
@XmlType(name = "arrayDataTypesType", propOrder = {
    "arrayData",
    "any"
})
@XmlSeeAlso({
    org.ieee.standards.ieee1516_2010.DataTypesType.ArrayDataTypes.class
})
public class ArrayDataTypesType {

    protected List<ArrayDataTypesType.ArrayData> arrayData;
    ...
    /**
     * Gets the value of the arrayData property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the arrayData property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getArrayData().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ArrayDataTypesType.ArrayData }
     * 
     * 
     */
    public List<ArrayDataTypesType.ArrayData> getArrayData() {
        if (arrayData == null) {
            arrayData = new ArrayList<ArrayDataTypesType.ArrayData>();
        }
